...
class _KubernetesClientFactory(object):
  ...
  def MakeClient(self) -> k8s_client.CoreV1Api:  # pylint: disable=invalid-name
    """Make a kubernetes API client."""
...
def make_client() -> k8s_client.CoreV1Api:
  """Make a kubernetes API client."""
  return _factory.MakeClient()
